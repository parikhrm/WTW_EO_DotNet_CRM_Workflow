...
namespace CRM_Workflow
{
    ...
    {
        public void qualityparameters_list(DataTable dta, string typeoferror)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select * from dbo.vw_crm_qc_qualityparameters_dotnet where 1=1 and typeoferror = @typeoferrorparam order by QualityParameters asc";
